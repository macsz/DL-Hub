...
#c.JupyterHub.data_files_path = '/opt/conda/envs/dl/share/jupyterhub'
...
c.JupyterHub.ssl_cert = '/root/fullchain.pem'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
c.JupyterHub.ssl_key = '/root/privkey.pem'
